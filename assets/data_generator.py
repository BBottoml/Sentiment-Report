# Sentiment Report -- data_generator.py
# From StockIt - https://github.com/penguin2048/StockIt
import csv
import json
import os
import time
...
def generate(ticker):
    ...
    stocktwit_url = "https://api.stocktwits.com/api/2/streams/symbol/" + \
        SYMBOL + ".json?" + access_token[token]
